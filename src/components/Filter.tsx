    ...
    return (
        <form action="#">
            <fieldset className="flex items-center justify-center gap-[18px] h-[52px] mt-4 py-4 px-5 rounded-[5px] bg-white dark:bg-dark-800 font-bold text-[14px] text-light-400">
                <div>
                    <input onInput={showAll} type="radio" id="all" name="filter" className="peer hidden" />
                ...
                <div>
                    <input onInput={showActive} type="radio" id="active" name="filter" className="peer hidden" />
                ...
                <div>
                    <input onInput={showCompleted} type="radio" id="completed" name="filter" className="peer hidden" />
